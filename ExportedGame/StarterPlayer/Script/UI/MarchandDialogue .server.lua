...
local u6 = v2:WaitForChild("PurchaseItem", 10)
local u7 = v2:WaitForChild("GetMerchantItems", 10)
local u8 = {
...
local function u31() --[[ Line: 91 ]]
    ...
    v26.Text = "\226\128\148 Marchandises \226\128\148"
            ...
            task.spawn(function() --[[ Line: 353 ]]
                ...
                if u10 and u9 then
                    if v45 then
                        ...
                        local u47 = u34
                        local u48 = v46 or "Merci pour ton achat !"
                        ...
                        if u10 and (u34 and u34.Parent) then
                            ...
                            if u53 and u53.Parent then
                                ...
                                local u54 = u12
                                u53.Text = ""
                                local u55 = "Bienvenue, inconnu. J\'ai de belles marchandises \195\160 te proposer. Regarde ce que j\'ai en stock."
                                local u56 = nil
                                task.spawn(function() --[[ Line: 75 ]]
                                    --[[
                                    Upvalues:
                        ...
                        if u10 and (u34 and u34.Parent) then
                            ...
                            if u65 and u65.Parent then
                                ...
                                local u66 = u12
                                u65.Text = ""
                                local u67 = "Bienvenue, inconnu. J\'ai de belles marchandises \195\160 te proposer. Regarde ce que j\'ai en stock."
                                local u68 = nil
                                task.spawn(function() --[[ Line: 75 ]]
                                    --[[
                                    Upvalues:
    ...
    if not u10 then
        ...
        v82.Completed:Connect(function() --[[ Line: 457 ]]
            ...
            if u83 then
                ...
                local u84 = u12
                u83.Text = ""
                local u85 = "Bienvenue, inconnu. J\'ai de belles marchandises \195\160 te proposer. Regarde ce que j\'ai en stock."
                local u86 = nil
                task.spawn(function() --[[ Line: 75 ]]
                    --[[
                    Upvalues:
        ...
        u79.MouseButton1Click:Connect(function() --[[ Line: 482 ]]
            ...
            if u10 then
                ...
                if u94 and u94.Parent then
                    ...
                    local u96 = u12
                    u94.Text = ""
                    local u97 = "Au revoir, famille. Reviens quand tu veux."
                    task.spawn(function() --[[ Line: 75 ]]
                        --[[
                        Upvalues:
                            [1] = u97
...
local function u106() --[[ Line: 520 ]]
    ...
    local v101 = nil
    for _ = 1, 15 do
        v101 = workspace:FindFirstChild("Vendeurs")
        if v101 then
            break
        end
        task.wait(2)
    end
    local v102 = v101 or workspace:WaitForChild("Vendeurs", 60)
    if not v102 then
        warn("[Marchand] ERREUR: \'Vendeurs\' introuvable pour", u4.Name)
        return
    end
    local v103 = nil
    for _ = 1, 15 do
    ...
    if v104 then
        u14 = v104.Triggered:Connect(function(p105) --[[ Line: 570 ]]
            --[[
            Upvalues:
                [1] = u4
                [2] = u100
        ...
        warn("[Marchand] ERREUR: ProximityPrompt introuvable pour", u4.Name)
    end
end
u4.CharacterAdded:Connect(function() --[[ Line: 577 ]]
    --[[
    Upvalues:
        [1] = u12
        [2] = u10
    ...
    task.spawn(function() --[[ Line: 580 ]]
        ...
        Upvalues:
            [1] = u106
        --]]
        local v107, v108 = pcall(u106)
        if not v107 then
            warn("[Marchand] Erreur:", v108)
        end
    end)
end)
if u4.Character then
    task.spawn(function() --[[ Line: 589 ]]
        ...
        Upvalues:
            [1] = u106
        --]]
        local v109, v110 = pcall(u106)
        if not v109 then
            warn("[Marchand] Erreur:", v110)
        end
    end)
else
    ...
    task.spawn(function() --[[ Line: 598 ]]
        ...
        Upvalues:
            [1] = u106
        --]]
        local v111, v112 = pcall(u106)
        if not v111 then
            warn("[Marchand] Erreur:", v112)
        end
    end)
end