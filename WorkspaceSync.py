...
TARGET_MODULE_DIR = os.path.abspath(os.path.join(WORKSPACE_DIR, "2STEP-AOT-Modules"))

# Timing sync paths
SOURCE_TIMING_DIR = os.path.abspath('./Timings')
TARGET_TIMING_DIR = os.path.abspath(os.path.join(WORKSPACE_DIR, "2STEP-AOT-Timings"))
